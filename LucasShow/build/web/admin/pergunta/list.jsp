                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="ttupd" class="icon material-icons">
                                <i class="material-icons"><a href="upd.jsp?IdPergunta=<%=obj.getId()%>">update</a></i>
                            </div>
                            ...
                            <div id="ttdel" class="icon material-icons">
                                <i class="material-icons"><a href="del-ok.jsp?IdPergunta=<%=obj.getId()%>">delete</a></i>
                            </div>
